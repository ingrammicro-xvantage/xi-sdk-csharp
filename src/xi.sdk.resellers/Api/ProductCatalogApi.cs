    ...
    public partial class ProductCatalogApi : IDisposable, IProductCatalogApi
    {
        ...
        public xi.sdk.resellers.Client.ApiResponse<List<PriceAndAvailabilityResponseInner>> PostPriceandavailabilityWithHttpInfo(List<bool> includeAvailability, bool includePricing, string iMCustomerNumber, string iMCountryCode, string iMCorrelationID, PriceAndAvailabilityRequest priceAndAvailabilityRequest, bool? includeProductAttributes = default(bool?), string? iMSenderID = default(string?))
        {
            ...
            if (includeAvailability == null)
                throw new xi.sdk.resellers.Client.ApiException(400, "Missing required parameter 'includeAvailability' when calling ProductCatalogApi->PostPriceandavailability");
            ...
            localVarRequestOptions.QueryParameters.Add(xi.sdk.resellers.Client.ClientUtils.ParameterToMultiMap("multi", "includeAvailability", includeAvailability));
