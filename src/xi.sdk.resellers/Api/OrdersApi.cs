...
namespace xi.sdk.resellers.Api
{
    ...
    public partial class OrdersApi : IDisposable, IOrdersApi
    {
        ...
        /// <param name="regionCode">Region code for sandbox testing - Not for use in production. (optional)</param>
        /// <returns>ApiResponse of OrderDetailB2B</returns>
        public xi.sdk.resellers.Client.ApiResponse<OrderDetailB2B> GetOrderdetailsV61WithHttpInfo(string ordernumber, string iMCustomerNumber, string iMCountryCode, string iMCorrelationID, string? iMSenderID = default(string?), DateTime? ingramOrderDate = default(DateTime?), string? vendorNumber = default(string?), string? simulateStatus = default(string?), bool? isIml = default(bool?), string? regionCode = default(string?))
        {
            // verify the required parameter 'ordernumber' is set
            if (ordernumber == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (OrderDetailB2B)</returns>
        public async System.Threading.Tasks.Task<xi.sdk.resellers.Client.ApiResponse<OrderDetailB2B>> GetOrderdetailsV61WithHttpInfoAsync(string ordernumber, string iMCustomerNumber, string iMCountryCode, string iMCorrelationID, string? iMSenderID = default(string?), DateTime? ingramOrderDate = default(DateTime?), string? vendorNumber = default(string?), string? simulateStatus = default(string?), bool? isIml = default(bool?), string? regionCode = default(string?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'ordernumber' is set
            if (ordernumber == null)
                throw new xi.sdk.resellers.Client.ApiException(400, "Missing required parameter 'ordernumber' when calling OrdersApi->GetOrderdetailsV61");
