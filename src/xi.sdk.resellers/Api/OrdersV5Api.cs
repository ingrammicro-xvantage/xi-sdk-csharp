...
namespace xi.sdk.resellers.Api
{
    ...
    public partial class OrdersV5Api : IDisposable, IOrdersV5Api
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (OrderDetailResponse)</returns>
        public async System.Threading.Tasks.Task<xi.sdk.resellers.Client.ApiResponse<OrderDetailResponse>> GetV5OrdersDetailsWithHttpInfoAsync(string ordernumber, string customernumber, string isocountrycode, string? customerordernumber = default(string?), DateTime? startcreatetimestamp = default(DateTime?), string? endcreatetimestamp = default(string?), string? simulate = default(string?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'ordernumber' is set
            if (ordernumber == null)
                throw new xi.sdk.resellers.Client.ApiException(400, "Missing required parameter 'ordernumber' when calling OrdersV5Api->GetV5OrdersDetails");
