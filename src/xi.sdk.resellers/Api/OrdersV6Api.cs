...
namespace xi.sdk.resellers.Api
{
    ...
    public interface IOrdersV6ApiSync : IApiAccessor
    {
        ...
        OrderDetailResponse GetOrderdetailsV6(string ordernumber, string iMCustomerNumber, string iMCountryCode, string iMCorrelationID, string? iMSenderID = default(string?), DateOnly? ingramOrderDate = default(DateOnly?), string? vendorNumber = default(string?), string? simulateStatus = default(string?), bool? isIml = default(bool?), string? regionCode = default(string?));
        ...
        ApiResponse<OrderDetailResponse> GetOrderdetailsV6WithHttpInfo(string ordernumber, string iMCustomerNumber, string iMCountryCode, string iMCorrelationID, string? iMSenderID = default(string?), DateOnly? ingramOrderDate = default(DateOnly?), string? vendorNumber = default(string?), string? simulateStatus = default(string?), bool? isIml = default(bool?), string? regionCode = default(string?));
    ...
    public interface IOrdersV6ApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<OrderDetailResponse> GetOrderdetailsV6Async(string ordernumber, string iMCustomerNumber, string iMCountryCode, string iMCorrelationID, string? iMSenderID = default(string?), DateOnly? ingramOrderDate = default(DateOnly?), string? vendorNumber = default(string?), string? simulateStatus = default(string?), bool? isIml = default(bool?), string? regionCode = default(string?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<OrderDetailResponse>> GetOrderdetailsV6WithHttpInfoAsync(string ordernumber, string iMCustomerNumber, string iMCountryCode, string iMCorrelationID, string? iMSenderID = default(string?), DateOnly? ingramOrderDate = default(DateOnly?), string? vendorNumber = default(string?), string? simulateStatus = default(string?), bool? isIml = default(bool?), string? regionCode = default(string?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class OrdersV6Api : IDisposable, IOrdersV6Api
    {
        ...
        /// <returns></returns>
        public OrdersV6Api(xi.sdk.resellers.Client.Configuration configuration)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public OrdersV6Api(HttpClient client, xi.sdk.resellers.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public OrdersV6Api(xi.sdk.resellers.Client.ISynchronousClient client, xi.sdk.resellers.Client.IAsynchronousClient asyncClient, xi.sdk.resellers.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <param name="regionCode">Region code for sandbox testing - Not for use in production. (optional)</param>
        /// <returns>OrderDetailResponse</returns>
        public OrderDetailResponse GetOrderdetailsV6(string ordernumber, string iMCustomerNumber, string iMCountryCode, string iMCorrelationID, string? iMSenderID = default(string?), DateOnly? ingramOrderDate = default(DateOnly?), string? vendorNumber = default(string?), string? simulateStatus = default(string?), bool? isIml = default(bool?), string? regionCode = default(string?))
        {
            xi.sdk.resellers.Client.ApiResponse<OrderDetailResponse> localVarResponse = GetOrderdetailsV6WithHttpInfo(ordernumber, iMCustomerNumber, iMCountryCode, iMCorrelationID, iMSenderID, ingramOrderDate, vendorNumber, simulateStatus, isIml, regionCode);
        ...
        /// <param name="regionCode">Region code for sandbox testing - Not for use in production. (optional)</param>
        /// <returns>ApiResponse of OrderDetailResponse</returns>
        public xi.sdk.resellers.Client.ApiResponse<OrderDetailResponse> GetOrderdetailsV6WithHttpInfo(string ordernumber, string iMCustomerNumber, string iMCountryCode, string iMCorrelationID, string? iMSenderID = default(string?), DateOnly? ingramOrderDate = default(DateOnly?), string? vendorNumber = default(string?), string? simulateStatus = default(string?), bool? isIml = default(bool?), string? regionCode = default(string?))
        {
            // verify the required parameter 'ordernumber' is set
            if (ordernumber == null)
                throw new xi.sdk.resellers.Client.ApiException(400, "Missing required parameter 'ordernumber' when calling OrdersV6Api->GetOrderdetailsV6");

            // verify the required parameter 'iMCustomerNumber' is set
            if (iMCustomerNumber == null)
                throw new xi.sdk.resellers.Client.ApiException(400, "Missing required parameter 'iMCustomerNumber' when calling OrdersV6Api->GetOrderdetailsV6");

            // verify the required parameter 'iMCountryCode' is set
            if (iMCountryCode == null)
                throw new xi.sdk.resellers.Client.ApiException(400, "Missing required parameter 'iMCountryCode' when calling OrdersV6Api->GetOrderdetailsV6");

            // verify the required parameter 'iMCorrelationID' is set
            if (iMCorrelationID == null)
                throw new xi.sdk.resellers.Client.ApiException(400, "Missing required parameter 'iMCorrelationID' when calling OrdersV6Api->GetOrderdetailsV6");
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of OrderDetailResponse</returns>
        public async System.Threading.Tasks.Task<OrderDetailResponse> GetOrderdetailsV6Async(string ordernumber, string iMCustomerNumber, string iMCountryCode, string iMCorrelationID, string? iMSenderID = default(string?), DateOnly? ingramOrderDate = default(DateOnly?), string? vendorNumber = default(string?), string? simulateStatus = default(string?), bool? isIml = default(bool?), string? regionCode = default(string?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            xi.sdk.resellers.Client.ApiResponse<OrderDetailResponse> localVarResponse = await GetOrderdetailsV6WithHttpInfoAsync(ordernumber, iMCustomerNumber, iMCountryCode, iMCorrelationID, iMSenderID, ingramOrderDate, vendorNumber, simulateStatus, isIml, regionCode, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (OrderDetailResponse)</returns>
        public async System.Threading.Tasks.Task<xi.sdk.resellers.Client.ApiResponse<OrderDetailResponse>> GetOrderdetailsV6WithHttpInfoAsync(string ordernumber, string iMCustomerNumber, string iMCountryCode, string iMCorrelationID, string? iMSenderID = default(string?), DateOnly? ingramOrderDate = default(DateOnly?), string? vendorNumber = default(string?), string? simulateStatus = default(string?), bool? isIml = default(bool?), string? regionCode = default(string?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'ordernumber' is set
            if (ordernumber == null)
                throw new xi.sdk.resellers.Client.ApiException(400, "Missing required parameter 'ordernumber' when calling OrdersV6Api->GetOrderdetailsV6");
