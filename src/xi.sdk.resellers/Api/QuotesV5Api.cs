...
namespace xi.sdk.resellers.Api
{
    ...
    public partial class QuotesV5Api : IDisposable, IQuotesV5Api
    {
        ...
        /// <returns></returns>
        public QuotesV5Api(xi.sdk.resellers.Client.Configuration configuration)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public QuotesV5Api(HttpClient client, xi.sdk.resellers.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public QuotesV5Api(xi.sdk.resellers.Client.ISynchronousClient client, xi.sdk.resellers.Client.IAsynchronousClient asyncClient, xi.sdk.resellers.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        {
            xi.sdk.resellers.Client.ApiResponse<QuoteDetails> localVarResponse = GetV5QuotesDetailsWithHttpInfo(quoteNumber, customerNumber, isoCountryCode, thirdPartySource);
        ...
        /// <param name="thirdPartySource">Unique identifier used to identify the third party source accessing the services (optional, default to &quot;customer&quot;)</param>
        /// <returns>ApiResponse of QuoteDetails</returns>
        public xi.sdk.resellers.Client.ApiResponse<QuoteDetails> GetV5QuotesDetailsWithHttpInfo(string quoteNumber, string customerNumber, string isoCountryCode, string? thirdPartySource = default(string?))
        {
            // verify the required parameter 'quoteNumber' is set
            if (quoteNumber == null)
                throw new xi.sdk.resellers.Client.ApiException(400, "Missing required parameter 'quoteNumber' when calling QuotesV5Api->GetV5QuotesDetails");

            // verify the required parameter 'customerNumber' is set
            if (customerNumber == null)
                throw new xi.sdk.resellers.Client.ApiException(400, "Missing required parameter 'customerNumber' when calling QuotesV5Api->GetV5QuotesDetails");

            // verify the required parameter 'isoCountryCode' is set
            if (isoCountryCode == null)
                throw new xi.sdk.resellers.Client.ApiException(400, "Missing required parameter 'isoCountryCode' when calling QuotesV5Api->GetV5QuotesDetails");
            ...
            {
                localVarRequestOptions.QueryParameters.Add(xi.sdk.resellers.Client.ClientUtils.ParameterToMultiMap("", "thirdPartySource", thirdPartySource));
            }
        ...
        {
            xi.sdk.resellers.Client.ApiResponse<QuoteDetails> localVarResponse = await GetV5QuotesDetailsWithHttpInfoAsync(quoteNumber, customerNumber, isoCountryCode, thirdPartySource, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (QuoteDetails)</returns>
        public async System.Threading.Tasks.Task<xi.sdk.resellers.Client.ApiResponse<QuoteDetails>> GetV5QuotesDetailsWithHttpInfoAsync(string quoteNumber, string customerNumber, string isoCountryCode, string? thirdPartySource = default(string?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'quoteNumber' is set
            if (quoteNumber == null)
                throw new xi.sdk.resellers.Client.ApiException(400, "Missing required parameter 'quoteNumber' when calling QuotesV5Api->GetV5QuotesDetails");
        ...
        {
            xi.sdk.resellers.Client.ApiResponse<QuoteListResponse> localVarResponse = PostV5QuotesSearchWithHttpInfo(quoteListRequest);
            return localVarResponse.Data;
        }
        ...
        /// <param name="quoteListRequest"> (optional)</param>
        /// <returns>ApiResponse of QuoteListResponse</returns>
        public xi.sdk.resellers.Client.ApiResponse<QuoteListResponse> PostV5QuotesSearchWithHttpInfo(QuoteListRequest? quoteListRequest = default(QuoteListRequest?))
        {
            xi.sdk.resellers.Client.RequestOptions localVarRequestOptions = new xi.sdk.resellers.Client.RequestOptions();
        ...
        {
            xi.sdk.resellers.Client.ApiResponse<QuoteListResponse> localVarResponse = await PostV5QuotesSearchWithHttpInfoAsync(quoteListRequest, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (QuoteListResponse)</returns>
        public async System.Threading.Tasks.Task<xi.sdk.resellers.Client.ApiResponse<QuoteListResponse>> PostV5QuotesSearchWithHttpInfoAsync(QuoteListRequest? quoteListRequest = default(QuoteListRequest?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
