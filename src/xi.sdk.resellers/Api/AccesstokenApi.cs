...
namespace xi.sdk.resellers.Api
{
    ...
    public interface IAccesstokenApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<AccesstokenResponse> GetAccesstokenAsync(string grantType, string clientId, string clientSecret, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<AccesstokenResponse>> GetAccesstokenWithHttpInfoAsync(string grantType, string clientId, string clientSecret, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class AccesstokenApi : IDisposable, IAccesstokenApi
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of AccesstokenResponse</returns>
        public async System.Threading.Tasks.Task<AccesstokenResponse> GetAccesstokenAsync(string grantType, string clientId, string clientSecret, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AccesstokenResponse)</returns>
        public async System.Threading.Tasks.Task<xi.sdk.resellers.Client.ApiResponse<AccesstokenResponse>> GetAccesstokenWithHttpInfoAsync(string grantType, string clientId, string clientSecret, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'grantType' is set
            if (grantType == null)
                throw new xi.sdk.resellers.Client.ApiException(400, "Missing required parameter 'grantType' when calling AccesstokenApi->GetAccesstoken");
