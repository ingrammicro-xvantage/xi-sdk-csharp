...
namespace xi.sdk.resellers.Model
{
    ...
    /// </summary>
    [DataContract(Name = "multiSKUPriceAndStockRequest_servicerequest")]
    public partial class MultiSKUPriceAndStockRequestServicerequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MultiSKUPriceAndStockRequestServicerequest" /> class.
        /// </summary>
        /// <param name="requestpreamble">requestpreamble.</param>
        /// <param name="priceandstockrequest">priceandstockrequest.</param>
        public MultiSKUPriceAndStockRequestServicerequest(MultiSKUPriceAndStockRequestServicerequestRequestpreamble requestpreamble = default(MultiSKUPriceAndStockRequestServicerequestRequestpreamble), MultiSKUPriceAndStockRequestServicerequestPriceandstockrequest priceandstockrequest = default(MultiSKUPriceAndStockRequestServicerequestPriceandstockrequest))
        {
        ...
        public MultiSKUPriceAndStockRequestServicerequestRequestpreamble Requestpreamble { get; set; }

        /// <summary>
        /// Gets or Sets Priceandstockrequest
        /// </summary>
        [DataMember(Name = "priceandstockrequest", EmitDefaultValue = false)]
        public MultiSKUPriceAndStockRequestServicerequestPriceandstockrequest Priceandstockrequest { get; set; }
