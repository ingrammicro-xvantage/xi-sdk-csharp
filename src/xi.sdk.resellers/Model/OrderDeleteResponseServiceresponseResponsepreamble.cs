...
namespace xi.sdk.resellers.Model
{
    ...
    /// </summary>
    [DataContract(Name = "orderDeleteResponse_serviceresponse_responsepreamble")]
    public partial class OrderDeleteResponseServiceresponseResponsepreamble : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderDeleteResponseServiceresponseResponsepreamble" /> class.
        /// </summary>
        ...
        public OrderDeleteResponseServiceresponseResponsepreamble(string requestStatus = default(string), string returnCode = default(string), string returnMessage = default(string))
        {
