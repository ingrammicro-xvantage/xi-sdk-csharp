...
namespace xi.sdk.resellers.Model
{
    ...
    public partial class DealsDetailsResponse : IValidatableObject
    {
        ...
        public DealsDetailsResponse(string dealId = default(string), string varVersion = default(string), string endUser = default(string), decimal extendedMsrp = default(decimal), string vendor = default(string), DateTime dealReceivedOn = default(DateTime), DateTime dealExpiryDate = default(DateTime), DateTime priceProtectionEndDate = default(DateTime), string currencyCode = default(string), List<RenewalsDetailsResponseEndUserInfoInner> endUserInfo = default(List<RenewalsDetailsResponseEndUserInfoInner>), List<DealsDetailsResponseProductsInner> products = default(List<DealsDetailsResponseProductsInner>))
        {
            this.DealId = dealId;
        ...
        public DateTime DealReceivedOn { get; set; }
        ...
        [JsonConverter(typeof(OpenAPIDateConverter))]
        public DateTime PriceProtectionEndDate { get; set; }
