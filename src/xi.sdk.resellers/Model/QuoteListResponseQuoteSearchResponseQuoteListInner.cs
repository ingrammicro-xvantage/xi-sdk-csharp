...
namespace xi.sdk.resellers.Model
{
    ...
    public partial class QuoteListResponseQuoteSearchResponseQuoteListInner : IValidatableObject
    {
        ...
        public QuoteListResponseQuoteSearchResponseQuoteListInner(string quoteName = default(string), string quoteNumber = default(string), int revisionNumber = default(int), string endUserName = default(string), string bidNumber = default(string), string totalAmount = default(string), string quoteStatus = default(string), DateOnly createdDate = default(DateOnly), DateOnly lastModifiedDate = default(DateOnly), DateOnly quoteExpiryDate = default(DateOnly))
        {
