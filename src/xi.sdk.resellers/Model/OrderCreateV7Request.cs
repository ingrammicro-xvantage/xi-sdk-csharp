...
namespace xi.sdk.resellers.Model
{
    ...
    public partial class OrderCreateV7Request : IValidatableObject
    {
        ...
        public OrderCreateV7Request(string quoteNumber = default(string), string customerOrderNumber = default(string), string endCustomerOrderNumber = default(string), string notes = default(string), string billToAddressId = default(string), string specialBidNumber = default(string), bool? acceptBackOrder = default(bool?), string vendAuthNumber = default(string), OrderCreateV7RequestResellerInfo resellerInfo = default(OrderCreateV7RequestResellerInfo), OrderCreateV7RequestEndUserInfo endUserInfo = default(OrderCreateV7RequestEndUserInfo), OrderCreateV7RequestShipToInfo shipToInfo = default(OrderCreateV7RequestShipToInfo), OrderCreateV7RequestShipmentDetails shipmentDetails = default(OrderCreateV7RequestShipmentDetails), List<OrderCreateV7RequestAdditionalAttributesInner> additionalAttributes = default(List<OrderCreateV7RequestAdditionalAttributesInner>), List<OrderCreateV7RequestVmfAdditionalAttributesInner> vmfAdditionalAttributes = default(List<OrderCreateV7RequestVmfAdditionalAttributesInner>), List<OrderCreateV7RequestLinesInner> lines = default(List<OrderCreateV7RequestLinesInner>))
        {
        ...
        [DataMember(Name = "vmfAdditionalAttributes", EmitDefaultValue = true)]
