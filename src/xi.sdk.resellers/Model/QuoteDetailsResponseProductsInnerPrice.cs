...
namespace xi.sdk.resellers.Model
{
    ...
    public partial class QuoteDetailsResponseProductsInnerPrice : IValidatableObject
    {
        ...
        public QuoteDetailsResponseProductsInnerPrice(decimal? quotePrice = default(decimal?), decimal? msrp = default(decimal?), decimal? extendedMsrp = default(decimal?), decimal? extendedQuotePrice = default(decimal?), decimal? remainingQuantityExtendedMsrp = default(decimal?), decimal? remainingQuantityExtendedQuotePrice = default(decimal?), string discountOffList = default(string), string type = default(string), string recurringPriceModel = default(string), string unitOfMeasure = default(string), decimal? tax = default(decimal?), decimal? extrafees = default(decimal?), List<QuoteDetailsResponseProductsInnerPriceExtraFeesDetailsInner> extraFeesDetails = default(List<QuoteDetailsResponseProductsInnerPriceExtraFeesDetailsInner>), List<QuoteDetailsResponseProductsInnerPriceDiscountsInner> discounts = default(List<QuoteDetailsResponseProductsInnerPriceDiscountsInner>))
        {
