...
namespace xi.sdk.resellers.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AsyncOrderCreateDTO_additionalAttributes_inner")]
    public partial class AsyncOrderCreateDTOAdditionalAttributesInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AsyncOrderCreateDTOAdditionalAttributesInner" /> class.
        /// </summary>
        ...
        public AsyncOrderCreateDTOAdditionalAttributesInner(string attributeName = default(string), string attributeValue = default(string))
        {
