...
namespace xi.sdk.resellers.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OrderCreateResponse_orders_inner_links_inner")]
    public partial class OrderCreateResponseOrdersInnerLinksInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderCreateResponseOrdersInnerLinksInner" /> class.
        /// </summary>
        ...
        public OrderCreateResponseOrdersInnerLinksInner(string topic = default(string), string href = default(string), string type = default(string))
        {
            this.Topic = topic;
            this.Href = href;
            this.Type = type;
