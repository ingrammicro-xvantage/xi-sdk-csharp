...
namespace xi.sdk.resellers.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OrderDetailResponse_lines_inner")]
    public partial class OrderDetailResponseLinesInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderDetailResponseLinesInner" /> class.
        /// </summary>
        ...
        public OrderDetailResponseLinesInner(string subOrderNumber = default(string), string ingramOrderLineNumber = default(string), string vendorSalesOrderLineNumber = default(string), string customerLinenumber = default(string), string lineStatus = default(string), string ingramPartNumber = default(string), string vendorPartNumber = default(string), string vendorName = default(string), string partDescription = default(string), decimal unitWeight = default(decimal), string weightUom = default(string), int unitPrice = default(int), string upcCode = default(string), decimal extendedPrice = default(decimal), decimal taxAmount = default(decimal), string currencyCode = default(string), int quantityOrdered = default(int), int quantityConfirmed = default(int), int quantityBackOrdered = default(int), string specialBidNumber = default(string), DateOnly requestedDeliveryDate = default(DateOnly), DateOnly promisedDeliveryDate = default(DateOnly), string lineNotes = default(string), List<OrderDetailResponseLinesInnerShipmentDetailsInner> shipmentDetails = default(List<OrderDetailResponseLinesInnerShipmentDetailsInner>), List<OrderDetailResponseLinesInnerAdditionalAttributesInner> additionalAttributes = default(List<OrderDetailResponseLinesInnerAdditionalAttributesInner>), List<OrderDetailResponseLinesInnerLinksInner> links = default(List<OrderDetailResponseLinesInnerLinksInner>))
        {
        ...
        public List<OrderDetailResponseLinesInnerShipmentDetailsInner> ShipmentDetails { get; set; }
        ...
        public List<OrderDetailResponseLinesInnerLinksInner> Links { get; set; }
