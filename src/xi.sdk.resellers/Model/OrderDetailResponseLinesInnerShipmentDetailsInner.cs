...
namespace xi.sdk.resellers.Model
{
    ...
    public partial class OrderDetailResponseLinesInnerShipmentDetailsInner : IValidatableObject
    {
        ...
        public OrderDetailResponseLinesInnerShipmentDetailsInner(int quantity = default(int), DateOnly estimatedShipDate = default(DateOnly), DateOnly shippedDate = default(DateOnly), DateOnly estimatedDeliveryDate = default(DateOnly), DateOnly deliveredDate = default(DateOnly), string shipFromWarehouseId = default(string), string shipFromLocation = default(string), string invoiceNumber = default(string), DateOnly invoiceDate = default(DateOnly), OrderDetailResponseLinesInnerShipmentDetailsInnerCarrierDetails carrierDetails = default(OrderDetailResponseLinesInnerShipmentDetailsInnerCarrierDetails))
        {
