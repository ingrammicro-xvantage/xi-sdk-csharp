...
namespace xi.sdk.resellers.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AvailabilityAsyncNotificationRequest_resource_inner_links_inner")]
    public partial class AvailabilityAsyncNotificationRequestResourceInnerLinksInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AvailabilityAsyncNotificationRequestResourceInnerLinksInner" /> class.
        /// </summary>
        ...
        public AvailabilityAsyncNotificationRequestResourceInnerLinksInner(string topic = default(string), string href = default(string), string type = default(string))
        {
            this.Topic = topic;
            this.Href = href;
            this.Type = type;
