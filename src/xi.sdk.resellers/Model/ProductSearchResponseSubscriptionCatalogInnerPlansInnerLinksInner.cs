...
namespace xi.sdk.resellers.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProductSearch_Response_subscriptionCatalog_inner_plans_inner_links_inner")]
    public partial class ProductSearchResponseSubscriptionCatalogInnerPlansInnerLinksInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductSearchResponseSubscriptionCatalogInnerPlansInnerLinksInner" /> class.
        /// </summary>
        ...
        public ProductSearchResponseSubscriptionCatalogInnerPlansInnerLinksInner(string topic = default(string), string href = default(string), string type = default(string))
        {
            this.Topic = topic;
            this.Href = href;
            this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProductSearchResponseSubscriptionCatalogInnerPlansInnerLinksInner {\n");
