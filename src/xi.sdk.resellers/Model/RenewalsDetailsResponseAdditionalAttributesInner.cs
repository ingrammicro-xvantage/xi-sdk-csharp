...
namespace xi.sdk.resellers.Model
{
    ...
    public partial class RenewalsDetailsResponseAdditionalAttributesInner : IValidatableObject
    {
        ...
        public RenewalsDetailsResponseAdditionalAttributesInner(string attributeDescription = default(string), string attributeValue = default(string), DateTime startDate = default(DateTime), DateTime expirationDate = default(DateTime), string isConsolidated = default(string))
        {
