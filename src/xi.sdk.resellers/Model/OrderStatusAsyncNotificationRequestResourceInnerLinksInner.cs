...
namespace xi.sdk.resellers.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OrderStatusAsyncNotificationRequest_resource_inner_links_inner")]
    public partial class OrderStatusAsyncNotificationRequestResourceInnerLinksInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderStatusAsyncNotificationRequestResourceInnerLinksInner" /> class.
        /// </summary>
        ...
        public OrderStatusAsyncNotificationRequestResourceInnerLinksInner(string topic = default(string), string href = default(string), string type = default(string))
        {
            this.Topic = topic;
            this.Href = href;
            this.Type = type;
