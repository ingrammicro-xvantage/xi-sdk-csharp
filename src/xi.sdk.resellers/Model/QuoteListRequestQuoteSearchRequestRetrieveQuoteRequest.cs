...
namespace xi.sdk.resellers.Model
{
    ...
    public partial class QuoteListRequestQuoteSearchRequestRetrieveQuoteRequest : IValidatableObject
    {
        ...
        public QuoteListRequestQuoteSearchRequestRetrieveQuoteRequest(string quoteNumber = default(string), string bidNumber = default(string), string endUserName = default(string), DateOnly fromDate = default(DateOnly), DateOnly toDate = default(DateOnly), string pageIndex = default(string), string recordsPerPage = default(string), SortingEnum? sorting = default(SortingEnum?), string sortingColumnName = default(string), string thirdPartySource = default(string))
        {
