...
namespace xi-sdk-resellers-csharp.Api
{
    ...
    public partial class QuotesV5Api : IQuotesV5Api
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of QuoteDetails</returns>
        public xi-sdk-resellers-csharp.Client.ApiResponse<QuoteDetails> GetV5QuotesDetailsWithHttpInfo(string quoteNumber, string customerNumber, string isoCountryCode, string? thirdPartySource = default(string?), int operationIndex = 0)
        {
        ...
        {
            xi-sdk-resellers-csharp.Client.ApiResponse<QuoteDetails> localVarResponse = await GetV5QuotesDetailsWithHttpInfoAsync(quoteNumber, customerNumber, isoCountryCode, thirdPartySource, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (QuoteDetails)</returns>
        public async System.Threading.Tasks.Task<xi-sdk-resellers-csharp.Client.ApiResponse<QuoteDetails>> GetV5QuotesDetailsWithHttpInfoAsync(string quoteNumber, string customerNumber, string isoCountryCode, string? thirdPartySource = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'quoteNumber' is set
            if (quoteNumber == null)
            {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of QuoteListResponse</returns>
        public xi-sdk-resellers-csharp.Client.ApiResponse<QuoteListResponse> PostV5QuotesSearchWithHttpInfo(QuoteListRequest? quoteListRequest = default(QuoteListRequest?), int operationIndex = 0)
        {
            xi-sdk-resellers-csharp.Client.RequestOptions localVarRequestOptions = new xi-sdk-resellers-csharp.Client.RequestOptions();
        ...
        {
            xi-sdk-resellers-csharp.Client.ApiResponse<QuoteListResponse> localVarResponse = await PostV5QuotesSearchWithHttpInfoAsync(quoteListRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (QuoteListResponse)</returns>
        public async System.Threading.Tasks.Task<xi-sdk-resellers-csharp.Client.ApiResponse<QuoteListResponse>> PostV5QuotesSearchWithHttpInfoAsync(QuoteListRequest? quoteListRequest = default(QuoteListRequest?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
