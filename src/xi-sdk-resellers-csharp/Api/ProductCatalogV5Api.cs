...
namespace xi-sdk-resellers-csharp.Api
{
    ...
    public partial class ProductCatalogV5Api : IProductCatalogV5Api
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ProductSearchResponse</returns>
        public xi-sdk-resellers-csharp.Client.ApiResponse<ProductSearchResponse> GetV5CatalogProductsearchWithHttpInfo(string customerNumber, string isoCountryCode, string partNumber, int operationIndex = 0)
        {
        ...
        {
            xi-sdk-resellers-csharp.Client.ApiResponse<ProductSearchResponse> localVarResponse = await GetV5CatalogProductsearchWithHttpInfoAsync(customerNumber, isoCountryCode, partNumber, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ProductSearchResponse)</returns>
        public async System.Threading.Tasks.Task<xi-sdk-resellers-csharp.Client.ApiResponse<ProductSearchResponse>> GetV5CatalogProductsearchWithHttpInfoAsync(string customerNumber, string isoCountryCode, string partNumber, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'customerNumber' is set
            if (customerNumber == null)
            {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PriceAndAvailabilityResponse</returns>
        public xi-sdk-resellers-csharp.Client.ApiResponse<PriceAndAvailabilityResponse> MultiSKUPriceAndStockWithHttpInfo(PriceAndAvailabilityRequest? priceAndAvailabilityRequest = default(PriceAndAvailabilityRequest?), int operationIndex = 0)
        {
            xi-sdk-resellers-csharp.Client.RequestOptions localVarRequestOptions = new xi-sdk-resellers-csharp.Client.RequestOptions();
        ...
        {
            xi-sdk-resellers-csharp.Client.ApiResponse<PriceAndAvailabilityResponse> localVarResponse = await MultiSKUPriceAndStockWithHttpInfoAsync(priceAndAvailabilityRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
