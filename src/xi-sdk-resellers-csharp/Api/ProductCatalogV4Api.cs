...
namespace xi-sdk-resellers-csharp.Api
{
    ...
    public partial class ProductCatalogV4Api : IProductCatalogV4Api
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of MultiSKUPriceAndStockResponse</returns>
        public xi-sdk-resellers-csharp.Client.ApiResponse<MultiSKUPriceAndStockResponse> PostV4MultiskupriceandstockWithHttpInfo(MultiSKUPriceAndStockRequest? multiSKUPriceAndStockRequest = default(MultiSKUPriceAndStockRequest?), int operationIndex = 0)
        {
        ...
        {
            xi-sdk-resellers-csharp.Client.ApiResponse<MultiSKUPriceAndStockResponse> localVarResponse = await PostV4MultiskupriceandstockWithHttpInfoAsync(multiSKUPriceAndStockRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ProductSearchResponse</returns>
        public xi-sdk-resellers-csharp.Client.ApiResponse<ProductSearchResponse> PostV4ProductsearchWithHttpInfo(ProductSearchRequest? productSearchRequest = default(ProductSearchRequest?), int operationIndex = 0)
        {
            xi-sdk-resellers-csharp.Client.RequestOptions localVarRequestOptions = new xi-sdk-resellers-csharp.Client.RequestOptions();
        ...
        {
            xi-sdk-resellers-csharp.Client.ApiResponse<ProductSearchResponse> localVarResponse = await PostV4ProductsearchWithHttpInfoAsync(productSearchRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ProductSearchResponse)</returns>
        public async System.Threading.Tasks.Task<xi-sdk-resellers-csharp.Client.ApiResponse<ProductSearchResponse>> PostV4ProductsearchWithHttpInfoAsync(ProductSearchRequest? productSearchRequest = default(ProductSearchRequest?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
