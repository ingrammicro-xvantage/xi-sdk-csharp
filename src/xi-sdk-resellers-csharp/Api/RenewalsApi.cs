...
namespace xi-sdk-resellers-csharp.Api
{
    ...
    public partial class RenewalsApi : IRenewalsApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RenewalsDetailsResponse</returns>
        public xi-sdk-resellers-csharp.Client.ApiResponse<RenewalsDetailsResponse> GetResellersV6RenewalsdetailsWithHttpInfo(string iMCustomerNumber, string iMCountryCode, string iMCorrelationID, string renewalId, string? iMSenderID = default(string?), int operationIndex = 0)
        {
        ...
        {
            xi-sdk-resellers-csharp.Client.ApiResponse<RenewalsDetailsResponse> localVarResponse = await GetResellersV6RenewalsdetailsWithHttpInfoAsync(iMCustomerNumber, iMCountryCode, iMCorrelationID, renewalId, iMSenderID, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (RenewalsDetailsResponse)</returns>
        public async System.Threading.Tasks.Task<xi-sdk-resellers-csharp.Client.ApiResponse<RenewalsDetailsResponse>> GetResellersV6RenewalsdetailsWithHttpInfoAsync(string iMCustomerNumber, string iMCountryCode, string iMCorrelationID, string renewalId, string? iMSenderID = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'iMCustomerNumber' is set
            if (iMCustomerNumber == null)
            {
