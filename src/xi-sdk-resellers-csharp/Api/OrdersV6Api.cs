...
namespace xi-sdk-resellers-csharp.Api
{
    ...
    public partial class OrdersV6Api : IOrdersV6Api
    {
        ...
        {
            xi-sdk-resellers-csharp.Client.ApiResponse<OrderDetailResponse> localVarResponse = await GetOrderdetailsV6WithHttpInfoAsync(ordernumber, iMCustomerNumber, iMCountryCode, iMCorrelationID, iMSenderID, ingramOrderDate, vendorNumber, simulateStatus, isIml, regionCode, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
