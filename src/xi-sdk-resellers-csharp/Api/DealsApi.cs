...
namespace xi-sdk-resellers-csharp.Api
{
    ...
    public partial class DealsApi : IDealsApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of DealsDetailsResponse</returns>
        public xi-sdk-resellers-csharp.Client.ApiResponse<DealsDetailsResponse> GetResellersV6DealsdetailsWithHttpInfo(string iMCustomerNumber, string iMCountryCode, string iMCorrelationID, string dealId, string? iMSenderID = default(string?), int operationIndex = 0)
        {
        ...
        {
            xi-sdk-resellers-csharp.Client.ApiResponse<DealsDetailsResponse> localVarResponse = await GetResellersV6DealsdetailsWithHttpInfoAsync(iMCustomerNumber, iMCountryCode, iMCorrelationID, dealId, iMSenderID, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DealsDetailsResponse)</returns>
        public async System.Threading.Tasks.Task<xi-sdk-resellers-csharp.Client.ApiResponse<DealsDetailsResponse>> GetResellersV6DealsdetailsWithHttpInfoAsync(string iMCustomerNumber, string iMCountryCode, string iMCorrelationID, string dealId, string? iMSenderID = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'iMCustomerNumber' is set
            if (iMCustomerNumber == null)
            {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of DealsSearchResponse</returns>
        public xi-sdk-resellers-csharp.Client.ApiResponse<DealsSearchResponse> GetResellersV6DealssearchWithHttpInfo(string iMCustomerNumber, string iMCountryCode, string iMCorrelationID, string? iMSenderID = default(string?), string? endUser = default(string?), string? vendor = default(string?), string? dealId = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'iMCustomerNumber' is set
            if (iMCustomerNumber == null)
            {
        ...
        {
            xi-sdk-resellers-csharp.Client.ApiResponse<DealsSearchResponse> localVarResponse = await GetResellersV6DealssearchWithHttpInfoAsync(iMCustomerNumber, iMCountryCode, iMCorrelationID, iMSenderID, endUser, vendor, dealId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
