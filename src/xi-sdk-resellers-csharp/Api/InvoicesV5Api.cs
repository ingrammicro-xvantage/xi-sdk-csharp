...
namespace xi-sdk-resellers-csharp.Api
{
    ...
    public partial class InvoicesV5Api : IInvoicesV5Api
    {
        ...
        /// <returns></returns>
        public InvoicesV5Api(xi-sdk-resellers-csharp.Client.Configuration configuration)
        {
        ...
        public InvoicesV5Api(xi-sdk-resellers-csharp.Client.ISynchronousClient client, xi-sdk-resellers-csharp.Client.IAsynchronousClient asyncClient, xi-sdk-resellers-csharp.Client.IReadableConfiguration configuration)
        {
        ...
        {
            xi-sdk-resellers-csharp.Client.ApiResponse<InvoiceDetails> localVarResponse = GetInvoicesWithHttpInfo(invoiceNumber, customerNumber, isoCountryCode);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of InvoiceDetails</returns>
        public xi-sdk-resellers-csharp.Client.ApiResponse<InvoiceDetails> GetInvoicesWithHttpInfo(string invoiceNumber, string customerNumber, string isoCountryCode, int operationIndex = 0)
        {
            // verify the required parameter 'invoiceNumber' is set
            if (invoiceNumber == null)
            {
                throw new xi-sdk-resellers-csharp.Client.ApiException(400, "Missing required parameter 'invoiceNumber' when calling InvoicesV5Api->GetInvoices");
            }

            // verify the required parameter 'customerNumber' is set
            if (customerNumber == null)
            {
                throw new xi-sdk-resellers-csharp.Client.ApiException(400, "Missing required parameter 'customerNumber' when calling InvoicesV5Api->GetInvoices");
            }

            // verify the required parameter 'isoCountryCode' is set
            if (isoCountryCode == null)
            {
                throw new xi-sdk-resellers-csharp.Client.ApiException(400, "Missing required parameter 'isoCountryCode' when calling InvoicesV5Api->GetInvoices");
            }
        ...
        {
            xi-sdk-resellers-csharp.Client.ApiResponse<InvoiceDetails> localVarResponse = await GetInvoicesWithHttpInfoAsync(invoiceNumber, customerNumber, isoCountryCode, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (InvoiceDetails)</returns>
        public async System.Threading.Tasks.Task<xi-sdk-resellers-csharp.Client.ApiResponse<InvoiceDetails>> GetInvoicesWithHttpInfoAsync(string invoiceNumber, string customerNumber, string isoCountryCode, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'invoiceNumber' is set
            if (invoiceNumber == null)
            {
