...
namespace xi-sdk-resellers-csharp.Model
{
    ...
    public partial class DealsDetailsResponseProductsInner : IValidatableObject
    {
        ...
        public DealsDetailsResponseProductsInner(string ingramPartNumber = default(string), string vendorPartNumber = default(string), string upc = default(string), string productDescription = default(string), decimal msrp = default(decimal), decimal extendedMSRP = default(decimal), decimal standardPrice = default(decimal), int approvedQuantity = default(int), int remainingQuantity = default(int), string comments = default(string), string specialConditions = default(string), DateTime startDate = default(DateTime), DateTime expirationDate = default(DateTime), int daysRemaining = default(int))
        {
