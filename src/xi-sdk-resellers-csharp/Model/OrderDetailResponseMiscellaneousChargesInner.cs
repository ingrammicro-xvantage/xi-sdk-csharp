...
namespace xi-sdk-resellers-csharp.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OrderDetailResponse_miscellaneousCharges_inner")]
    public partial class OrderDetailResponseMiscellaneousChargesInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderDetailResponseMiscellaneousChargesInner" /> class.
        /// </summary>
        ...
        public OrderDetailResponseMiscellaneousChargesInner(string subOrderNumber = default(string), string chargeLineReference = default(string), string chargeDescription = default(string), double chargeAmount = default(double))
        {
