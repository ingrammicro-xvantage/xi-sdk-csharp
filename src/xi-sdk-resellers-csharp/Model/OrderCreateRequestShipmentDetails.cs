...
namespace xi-sdk-resellers-csharp.Model
{
    ...
    public partial class OrderCreateRequestShipmentDetails : IValidatableObject
    {
        ...
        public OrderCreateRequestShipmentDetails(string carrierCode = default(string), string freightAccountNumber = default(string), string shipComplete = default(string), DateTime requestedDeliveryDate = default(DateTime), bool signatureRequired = default(bool), string shippingInstructions = default(string))
        {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // RequestedDeliveryDate (DateTime) maxLength
            if (this.RequestedDeliveryDate != null && this.RequestedDeliveryDate.Length > 8)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for RequestedDeliveryDate, length must be less than 8.", new [] { "RequestedDeliveryDate" });
            }
