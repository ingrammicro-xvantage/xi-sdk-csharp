...
namespace xi-sdk-resellers-csharp.Model
{
    ...
    public partial class ProductDetailResponse : IValidatableObject
    {
        ...
        public ProductDetailResponse(string ingramPartNumber = default(string), string vendorPartNumber = default(string), bool productAuthorized = default(bool), string description = default(string), string productDetailDescription = default(string), string upc = default(string), string productCategory = default(string), string productSubcategory = default(string), string vendorName = default(string), string vendorNumber = default(string), string productStatusCode = default(string), string productClass = default(string), string customerPartNumber = default(string), List<ProductDetailResponseIndicatorsInner> indicators = default(List<ProductDetailResponseIndicatorsInner>), List<ProductDetailResponseCiscoFieldsInner> ciscoFields = default(List<ProductDetailResponseCiscoFieldsInner>), List<ProductDetailResponseTechnicalSpecificationsInner> technicalSpecifications = default(List<ProductDetailResponseTechnicalSpecificationsInner>), List<Object> warrantyInformation = default(List<Object>), ProductDetailResponseAdditionalInformation additionalInformation = default(ProductDetailResponseAdditionalInformation))
        {
