...
namespace xi.sdk.resellers.csharp.Api
{
    ...
    public partial class InvoicesV4Api : IDisposable, IInvoicesV4Api
    {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public InvoicesV4Api(HttpClient client, xi.sdk.resellers.csharp.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <param name="invoiceDetailRequest"> (optional)</param>
        /// <returns>ApiResponse of InvoiceDetailResponse</returns>
        public xi.sdk.resellers.csharp.Client.ApiResponse<InvoiceDetailResponse> PostV4InvoicedetailsWithHttpInfo(InvoiceDetailRequest? invoiceDetailRequest = default(InvoiceDetailRequest?))
        {
        ...
        {
            xi.sdk.resellers.csharp.Client.ApiResponse<InvoiceDetailResponse> localVarResponse = await PostV4InvoicedetailsWithHttpInfoAsync(invoiceDetailRequest, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (InvoiceDetailResponse)</returns>
        public async System.Threading.Tasks.Task<xi.sdk.resellers.csharp.Client.ApiResponse<InvoiceDetailResponse>> PostV4InvoicedetailsWithHttpInfoAsync(InvoiceDetailRequest? invoiceDetailRequest = default(InvoiceDetailRequest?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
