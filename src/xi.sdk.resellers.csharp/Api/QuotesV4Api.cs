...
namespace xi.sdk.resellers.csharp.Api
{
    ...
    public partial class QuotesV4Api : IDisposable, IQuotesV4Api
    {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public QuotesV4Api(HttpClient client, xi.sdk.resellers.csharp.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <param name="quoteDetailsRequest"> (optional)</param>
        /// <returns>ApiResponse of QuoteDetailsResponse</returns>
        public xi.sdk.resellers.csharp.Client.ApiResponse<QuoteDetailsResponse> PostV4QuotedetailsWithHttpInfo(QuoteDetailsRequest? quoteDetailsRequest = default(QuoteDetailsRequest?))
        {
        ...
        {
            xi.sdk.resellers.csharp.Client.ApiResponse<QuoteDetailsResponse> localVarResponse = await PostV4QuotedetailsWithHttpInfoAsync(quoteDetailsRequest, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (QuoteDetailsResponse)</returns>
        public async System.Threading.Tasks.Task<xi.sdk.resellers.csharp.Client.ApiResponse<QuoteDetailsResponse>> PostV4QuotedetailsWithHttpInfoAsync(QuoteDetailsRequest? quoteDetailsRequest = default(QuoteDetailsRequest?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// <param name="quoteListRequest"> (optional)</param>
        /// <returns>ApiResponse of QuoteListResponse</returns>
        public xi.sdk.resellers.csharp.Client.ApiResponse<QuoteListResponse> PostV4QuotesearchWithHttpInfo(QuoteListRequest? quoteListRequest = default(QuoteListRequest?))
        {
            xi.sdk.resellers.csharp.Client.RequestOptions localVarRequestOptions = new xi.sdk.resellers.csharp.Client.RequestOptions();
        ...
        {
            xi.sdk.resellers.csharp.Client.ApiResponse<QuoteListResponse> localVarResponse = await PostV4QuotesearchWithHttpInfoAsync(quoteListRequest, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (QuoteListResponse)</returns>
        public async System.Threading.Tasks.Task<xi.sdk.resellers.csharp.Client.ApiResponse<QuoteListResponse>> PostV4QuotesearchWithHttpInfoAsync(QuoteListRequest? quoteListRequest = default(QuoteListRequest?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
