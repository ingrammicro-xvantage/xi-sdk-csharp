...
namespace xi.sdk.resellers.csharp.Api
{
    ...
    public partial class InvoicesV5Api : IDisposable, IInvoicesV5Api
    {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public InvoicesV5Api(HttpClient client, xi.sdk.resellers.csharp.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <param name="isoCountryCode">ISO 2 char country code</param>
        /// <returns>ApiResponse of InvoiceDetails</returns>
        public xi.sdk.resellers.csharp.Client.ApiResponse<InvoiceDetails> GetInvoicesWithHttpInfo(string invoiceNumber, string customerNumber, string isoCountryCode)
        {
        ...
        {
            xi.sdk.resellers.csharp.Client.ApiResponse<InvoiceDetails> localVarResponse = await GetInvoicesWithHttpInfoAsync(invoiceNumber, customerNumber, isoCountryCode, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (InvoiceDetails)</returns>
        public async System.Threading.Tasks.Task<xi.sdk.resellers.csharp.Client.ApiResponse<InvoiceDetails>> GetInvoicesWithHttpInfoAsync(string invoiceNumber, string customerNumber, string isoCountryCode, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'invoiceNumber' is set
            if (invoiceNumber == null)
                throw new xi.sdk.resellers.csharp.Client.ApiException(400, "Missing required parameter 'invoiceNumber' when calling InvoicesV5Api->GetInvoices");
