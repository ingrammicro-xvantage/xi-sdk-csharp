...
namespace xi.sdk.resellers.csharp.Api
{
    ...
    public partial class QuotesApi : IDisposable, IQuotesApi
    {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public QuotesApi(HttpClient client, xi.sdk.resellers.csharp.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <param name="iMSenderID">Unique value used to identify the sender of the transaction. Example: MyCompany (optional)</param>
        /// <returns>ApiResponse of QuoteSearchResponse</returns>
        public xi.sdk.resellers.csharp.Client.ApiResponse<QuoteSearchResponse> GetQuotessearchV6WithHttpInfo(string iMCustomerNumber, string iMCountryCode, string iMCustomerContact, string iMCorrelationID, List<string>? ingramOrderDateBt = default(List<string>?), string? quoteNumber = default(string?), string? specialBidNumber = default(string?), string? endUserContact = default(string?), string? sortingOrder = default(string?), string? sortBy = default(string?), int? pageSize = default(int?), int? pageNumber = default(int?), string? vendorName = default(string?), string? quoteName = default(string?), string? status = default(string?), string? quoteCreateDateBt = default(string?), string? iMSenderID = default(string?))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (QuoteSearchResponse)</returns>
        public async System.Threading.Tasks.Task<xi.sdk.resellers.csharp.Client.ApiResponse<QuoteSearchResponse>> GetQuotessearchV6WithHttpInfoAsync(string iMCustomerNumber, string iMCountryCode, string iMCustomerContact, string iMCorrelationID, List<string>? ingramOrderDateBt = default(List<string>?), string? quoteNumber = default(string?), string? specialBidNumber = default(string?), string? endUserContact = default(string?), string? sortingOrder = default(string?), string? sortBy = default(string?), int? pageSize = default(int?), int? pageNumber = default(int?), string? vendorName = default(string?), string? quoteName = default(string?), string? status = default(string?), string? quoteCreateDateBt = default(string?), string? iMSenderID = default(string?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'iMCustomerNumber' is set
            if (iMCustomerNumber == null)
                throw new xi.sdk.resellers.csharp.Client.ApiException(400, "Missing required parameter 'iMCustomerNumber' when calling QuotesApi->GetQuotessearchV6");
        ...
        /// <param name="iMSenderID">Unique identifier used to identify the third party source accessing the services. (optional)</param>
        /// <returns>ApiResponse of ValidateQuoteResponse</returns>
        public xi.sdk.resellers.csharp.Client.ApiResponse<ValidateQuoteResponse> GetResellerV6ValidateQuoteWithHttpInfo(string quoteNumber, string iMCustomerNumber, string iMCountryCode, string iMCorrelationID, string? iMSenderID = default(string?))
        {
        ...
        {
            xi.sdk.resellers.csharp.Client.ApiResponse<ValidateQuoteResponse> localVarResponse = await GetResellerV6ValidateQuoteWithHttpInfoAsync(quoteNumber, iMCustomerNumber, iMCountryCode, iMCorrelationID, iMSenderID, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ValidateQuoteResponse)</returns>
        public async System.Threading.Tasks.Task<xi.sdk.resellers.csharp.Client.ApiResponse<ValidateQuoteResponse>> GetResellerV6ValidateQuoteWithHttpInfoAsync(string quoteNumber, string iMCustomerNumber, string iMCountryCode, string iMCorrelationID, string? iMSenderID = default(string?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'quoteNumber' is set
            if (quoteNumber == null)
                throw new xi.sdk.resellers.csharp.Client.ApiException(400, "Missing required parameter 'quoteNumber' when calling QuotesApi->GetResellerV6ValidateQuote");
        ...
        /// <param name="iMSenderID">Unique identifier used to identify the third party source accessing the services. (optional)</param>
        /// <returns>ApiResponse of QuoteDetailsResponse</returns>
        public xi.sdk.resellers.csharp.Client.ApiResponse<QuoteDetailsResponse> GetResellersV6QuotesWithHttpInfo(string iMCustomerNumber, string iMCountryCode, string iMCorrelationID, string quoteNumber, string? iMSenderID = default(string?))
        {
            // verify the required parameter 'iMCustomerNumber' is set
            if (iMCustomerNumber == null)
        ...
        {
            xi.sdk.resellers.csharp.Client.ApiResponse<QuoteDetailsResponse> localVarResponse = await GetResellersV6QuotesWithHttpInfoAsync(iMCustomerNumber, iMCountryCode, iMCorrelationID, quoteNumber, iMSenderID, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
