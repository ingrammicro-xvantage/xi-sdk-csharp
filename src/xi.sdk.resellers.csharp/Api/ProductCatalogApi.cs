...
namespace xi.sdk.resellers.csharp.Api
{
    ...
    public partial class ProductCatalogApi : IDisposable, IProductCatalogApi
    {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public ProductCatalogApi(HttpClient client, xi.sdk.resellers.csharp.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <param name="iMSenderID">Sender Identification text (optional)</param>
        /// <returns>ApiResponse of ProductDetailResponse</returns>
        public xi.sdk.resellers.csharp.Client.ApiResponse<ProductDetailResponse> GetResellerV6ProductdetailWithHttpInfo(string ingramPartNumber, string iMCustomerNumber, string iMCountryCode, string iMCorrelationID, string? iMSenderID = default(string?))
        {
        ...
        {
            xi.sdk.resellers.csharp.Client.ApiResponse<ProductDetailResponse> localVarResponse = await GetResellerV6ProductdetailWithHttpInfoAsync(ingramPartNumber, iMCustomerNumber, iMCountryCode, iMCorrelationID, iMSenderID, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
