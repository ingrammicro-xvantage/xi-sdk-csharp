...
namespace xi.sdk.resellers.csharp.Api
{
    ...
    public partial class FreightEstimateApi : IDisposable, IFreightEstimateApi
    {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public FreightEstimateApi(HttpClient client, xi.sdk.resellers.csharp.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <param name="freightRequest"> (optional)</param>
        /// <returns>ApiResponse of FreightResponse</returns>
        public xi.sdk.resellers.csharp.Client.ApiResponse<FreightResponse> PostFreightestimateWithHttpInfo(string iMCustomerNumber, string iMCountryCode, string iMCorrelationID, string iMCustomerContact, string? iMSenderID = default(string?), FreightRequest? freightRequest = default(FreightRequest?))
        {
        ...
        {
            xi.sdk.resellers.csharp.Client.ApiResponse<FreightResponse> localVarResponse = await PostFreightestimateWithHttpInfoAsync(iMCustomerNumber, iMCountryCode, iMCorrelationID, iMCustomerContact, iMSenderID, freightRequest, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
