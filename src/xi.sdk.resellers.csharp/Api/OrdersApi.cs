...
namespace xi.sdk.resellers.csharp.Api
{
    ...
    public partial class OrdersApi : IDisposable, IOrdersApi
    {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public OrdersApi(HttpClient client, xi.sdk.resellers.csharp.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <param name="iMSenderID">Unique value used to identify the sender of the transaction. Example: MyCompany (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public xi.sdk.resellers.csharp.Client.ApiResponse<Object> DeleteOrdercancelWithHttpInfo(string orderNumber, string iMCustomerNumber, string iMCountryCode, string iMCorrelationID, string? regionCode = default(string?), string? iMSenderID = default(string?))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<xi.sdk.resellers.csharp.Client.ApiResponse<Object>> DeleteOrdercancelWithHttpInfoAsync(string orderNumber, string iMCustomerNumber, string iMCountryCode, string iMCorrelationID, string? regionCode = default(string?), string? iMSenderID = default(string?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'orderNumber' is set
            if (orderNumber == null)
                throw new xi.sdk.resellers.csharp.Client.ApiException(400, "Missing required parameter 'orderNumber' when calling OrdersApi->DeleteOrdercancel");
        ...
        {
            xi.sdk.resellers.csharp.Client.ApiResponse<OrderDetailB2B> localVarResponse = await GetOrderdetailsV61WithHttpInfoAsync(ordernumber, iMCustomerNumber, iMCountryCode, iMCorrelationID, iMSenderID, ingramOrderDate, vendorNumber, simulateStatus, isIml, regionCode, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (OrderSearchResponse)</returns>
        public async System.Threading.Tasks.Task<xi.sdk.resellers.csharp.Client.ApiResponse<OrderSearchResponse>> GetResellersV6OrdersearchWithHttpInfoAsync(string iMCustomerNumber, string iMCountryCode, string iMCorrelationID, string? ingramOrderNumber = default(string?), string? orderStatus = default(string?), List<string>? orderStatusIn = default(List<string>?), string? ingramOrderDate = default(string?), List<string>? ingramOrderDateBt = default(List<string>?), string? iMSenderID = default(string?), string? customerOrderNumber = default(string?), int? pageSize = default(int?), int? pageNumber = default(int?), string? endCustomerOrderNumber = default(string?), List<string>? invoiceDateBt = default(List<string>?), List<string>? shipDateBt = default(List<string>?), List<string>? deliveryDateBt = default(List<string>?), string? ingramPartNumber = default(string?), string? vendorPartNumber = default(string?), string? serialNumber = default(string?), string? trackingNumber = default(string?), string? vendorName = default(string?), string? specialBidNumber = default(string?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'iMCustomerNumber' is set
            if (iMCustomerNumber == null)
                throw new xi.sdk.resellers.csharp.Client.ApiException(400, "Missing required parameter 'iMCustomerNumber' when calling OrdersApi->GetResellersV6Ordersearch");
        ...
        /// <param name="iMSenderID">Unique value used to identify the sender of the transaction. Example: MyCompany (optional)</param>
        /// <returns>ApiResponse of OrderCreateResponse</returns>
        public xi.sdk.resellers.csharp.Client.ApiResponse<OrderCreateResponse> PostCreateorderV6WithHttpInfo(string iMCustomerNumber, string iMCountryCode, string iMCorrelationID, OrderCreateRequest orderCreateRequest, string? iMSenderID = default(string?))
        {
            // verify the required parameter 'iMCustomerNumber' is set
            if (iMCustomerNumber == null)
        ...
        {
            xi.sdk.resellers.csharp.Client.ApiResponse<OrderCreateResponse> localVarResponse = await PostCreateorderV6WithHttpInfoAsync(iMCustomerNumber, iMCountryCode, iMCorrelationID, orderCreateRequest, iMSenderID, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="iMSenderID">Unique value used to identify the sender of the transaction. Example: MyCompany (optional)</param>
        /// <returns>ApiResponse of OrderModifyResponse</returns>
        public xi.sdk.resellers.csharp.Client.ApiResponse<OrderModifyResponse> PutOrdermodifyWithHttpInfo(string orderNumber, string iMCustomerNumber, string iMCountryCode, string iMCorrelationID, OrderModifyRequest orderModifyRequest, string? actionCode = default(string?), string? regionCode = default(string?), string? iMSenderID = default(string?))
        {
            // verify the required parameter 'orderNumber' is set
            if (orderNumber == null)
        ...
        {
            xi.sdk.resellers.csharp.Client.ApiResponse<OrderModifyResponse> localVarResponse = await PutOrdermodifyWithHttpInfoAsync(orderNumber, iMCustomerNumber, iMCountryCode, iMCorrelationID, orderModifyRequest, actionCode, regionCode, iMSenderID, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (OrderModifyResponse)</returns>
        public async System.Threading.Tasks.Task<xi.sdk.resellers.csharp.Client.ApiResponse<OrderModifyResponse>> PutOrdermodifyWithHttpInfoAsync(string orderNumber, string iMCustomerNumber, string iMCountryCode, string iMCorrelationID, OrderModifyRequest orderModifyRequest, string? actionCode = default(string?), string? regionCode = default(string?), string? iMSenderID = default(string?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'orderNumber' is set
            if (orderNumber == null)
                throw new xi.sdk.resellers.csharp.Client.ApiException(400, "Missing required parameter 'orderNumber' when calling OrdersApi->PutOrdermodify");
