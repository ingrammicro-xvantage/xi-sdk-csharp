...
namespace xi.sdk.resellers.csharp.Api
{
    ...
    public partial class QuoteToOrderApi : IDisposable, IQuoteToOrderApi
    {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public QuoteToOrderApi(HttpClient client, xi.sdk.resellers.csharp.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <param name="iMSenderID">Unique value used to identify the sender of the transaction. (optional)</param>
        /// <returns>ApiResponse of QuoteToOrderResponse</returns>
        public xi.sdk.resellers.csharp.Client.ApiResponse<QuoteToOrderResponse> PostQuoteToOrderV6WithHttpInfo(string iMCustomerNumber, string iMCountryCode, string iMCorrelationID, QuoteToOrderDetailsDTO quoteToOrderDetailsDTO, string? iMSenderID = default(string?))
        {
        ...
        {
            xi.sdk.resellers.csharp.Client.ApiResponse<QuoteToOrderResponse> localVarResponse = await PostQuoteToOrderV6WithHttpInfoAsync(iMCustomerNumber, iMCountryCode, iMCorrelationID, quoteToOrderDetailsDTO, iMSenderID, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (QuoteToOrderResponse)</returns>
        public async System.Threading.Tasks.Task<xi.sdk.resellers.csharp.Client.ApiResponse<QuoteToOrderResponse>> PostQuoteToOrderV6WithHttpInfoAsync(string iMCustomerNumber, string iMCountryCode, string iMCorrelationID, QuoteToOrderDetailsDTO quoteToOrderDetailsDTO, string? iMSenderID = default(string?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'iMCustomerNumber' is set
            if (iMCustomerNumber == null)
                throw new xi.sdk.resellers.csharp.Client.ApiException(400, "Missing required parameter 'iMCustomerNumber' when calling QuoteToOrderApi->PostQuoteToOrderV6");
