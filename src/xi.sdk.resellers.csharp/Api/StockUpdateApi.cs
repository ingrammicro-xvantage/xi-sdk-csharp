...
namespace xi.sdk.resellers.csharp.Api
{
    ...
    public partial class StockUpdateApi : IDisposable, IStockUpdateApi
    {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public StockUpdateApi(HttpClient client, xi.sdk.resellers.csharp.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <param name="availabilityAsyncNotificationRequest"></param>
        /// <returns>ApiResponse of Object(void)</returns>
        public xi.sdk.resellers.csharp.Client.ApiResponse<Object> ResellersV1WebhooksAvailabilityupdatePostWithHttpInfo(string targeturl, string xHubSignature, AvailabilityAsyncNotificationRequest availabilityAsyncNotificationRequest)
        {
