...
namespace xi.sdk.resellers.csharp.Api
{
    ...
    public partial class ReturnsApi : IDisposable, IReturnsApi
    {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public ReturnsApi(HttpClient client, xi.sdk.resellers.csharp.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <param name="iMSenderID">Unique value used to identify the sender of the transaction. Example: MyCompany (optional)</param>
        /// <returns>ApiResponse of ReturnsDetailsResponse</returns>
        public xi.sdk.resellers.csharp.Client.ApiResponse<ReturnsDetailsResponse> GetResellersV6ReturnsdetailsWithHttpInfo(string iMCustomerNumber, string iMCountryCode, string iMCorrelationID, string caseRequestNumber, string? iMSenderID = default(string?))
        {
        ...
        {
            xi.sdk.resellers.csharp.Client.ApiResponse<ReturnsDetailsResponse> localVarResponse = await GetResellersV6ReturnsdetailsWithHttpInfoAsync(iMCustomerNumber, iMCountryCode, iMCorrelationID, caseRequestNumber, iMSenderID, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ReturnsDetailsResponse)</returns>
        public async System.Threading.Tasks.Task<xi.sdk.resellers.csharp.Client.ApiResponse<ReturnsDetailsResponse>> GetResellersV6ReturnsdetailsWithHttpInfoAsync(string iMCustomerNumber, string iMCountryCode, string iMCorrelationID, string caseRequestNumber, string? iMSenderID = default(string?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'iMCustomerNumber' is set
            if (iMCustomerNumber == null)
                throw new xi.sdk.resellers.csharp.Client.ApiException(400, "Missing required parameter 'iMCustomerNumber' when calling ReturnsApi->GetResellersV6Returnsdetails");
        ...
        /// <param name="returnsCreateRequest"> (optional)</param>
        /// <returns>ApiResponse of ReturnsCreateResponse</returns>
        public xi.sdk.resellers.csharp.Client.ApiResponse<ReturnsCreateResponse> PostReturnscreateWithHttpInfo(string iMCustomerNumber, string iMCountryCode, string iMCorrelationID, string? iMSenderID = default(string?), ReturnsCreateRequest? returnsCreateRequest = default(ReturnsCreateRequest?))
        {
            // verify the required parameter 'iMCustomerNumber' is set
            if (iMCustomerNumber == null)
        ...
        {
            xi.sdk.resellers.csharp.Client.ApiResponse<ReturnsCreateResponse> localVarResponse = await PostReturnscreateWithHttpInfoAsync(iMCustomerNumber, iMCountryCode, iMCorrelationID, iMSenderID, returnsCreateRequest, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
