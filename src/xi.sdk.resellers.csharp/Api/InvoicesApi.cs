...
namespace xi.sdk.resellers.csharp.Api
{
    ...
    public partial class InvoicesApi : IDisposable, IInvoicesApi
    {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public InvoicesApi(HttpClient client, xi.sdk.resellers.csharp.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <param name="includeSerialNumbers">if serial in the response send as true or else false (optional)</param>
        /// <returns>ApiResponse of InvoiceDetailsv61Response</returns>
        public xi.sdk.resellers.csharp.Client.ApiResponse<InvoiceDetailsv61Response> GetInvoicedetailsV61WithHttpInfo(string invoiceNumber, string iMCustomerNumber, string iMCountryCode, string iMCorrelationID, string iMApplicationID, string? customerType = default(string?), bool? includeSerialNumbers = default(bool?))
        {
        ...
        {
            xi.sdk.resellers.csharp.Client.ApiResponse<InvoiceDetailsv61Response> localVarResponse = await GetInvoicedetailsV61WithHttpInfoAsync(invoiceNumber, iMCustomerNumber, iMCountryCode, iMCorrelationID, iMApplicationID, customerType, includeSerialNumbers, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
