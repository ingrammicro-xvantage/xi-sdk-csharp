...
namespace xi.sdk.resellers.csharp.Model
{
    ...
    /// </summary>
    [DataContract(Name = "invoiceDetailResponse")]
    public partial class InvoiceDetailResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvoiceDetailResponse" /> class.
        /// </summary>
        /// <param name="serviceresponse">serviceresponse.</param>
        public InvoiceDetailResponse(InvoiceDetailResponseServiceresponse serviceresponse = default(InvoiceDetailResponseServiceresponse))
        {
        ...
        public InvoiceDetailResponseServiceresponse Serviceresponse { get; set; }
