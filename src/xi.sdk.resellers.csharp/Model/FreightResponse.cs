...
namespace xi.sdk.resellers.csharp.Model
{
    ...
    /// FreightResponse
    /// </summary>
    [DataContract(Name = "freightResponse")]
    public partial class FreightResponse : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or Sets FreightEstimateResponse
        /// </summary>
        [DataMember(Name = "freightEstimateResponse", EmitDefaultValue = false)]
        public FreightResponseFreightEstimateResponse FreightEstimateResponse { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  FreightEstimateResponse: ").Append(FreightEstimateResponse).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
