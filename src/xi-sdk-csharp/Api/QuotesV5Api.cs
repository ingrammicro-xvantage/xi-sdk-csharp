...
namespace xi-sdk-csharp.Api
{
    ...
    public interface IQuotesV5ApiSync : IApiAccessor
    {
        ...
        QuoteDetails GetV5QuotesDetails(string quoteNumber, string customerNumber, string isoCountryCode, string? thirdPartySource = default(string?), int operationIndex = 0);
        ...
        ApiResponse<QuoteDetails> GetV5QuotesDetailsWithHttpInfo(string quoteNumber, string customerNumber, string isoCountryCode, string? thirdPartySource = default(string?), int operationIndex = 0);
        /// <summary>
        /// Search Quotes
        /// </summary>
        /// <remarks>
        ...
        QuoteListResponse PostV5QuotesSearch(QuoteListRequest? quoteListRequest = default(QuoteListRequest?), int operationIndex = 0);
        ...
        ApiResponse<QuoteListResponse> PostV5QuotesSearchWithHttpInfo(QuoteListRequest? quoteListRequest = default(QuoteListRequest?), int operationIndex = 0);
    ...
    public interface IQuotesV5ApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<QuoteDetails> GetV5QuotesDetailsAsync(string quoteNumber, string customerNumber, string isoCountryCode, string? thirdPartySource = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<QuoteDetails>> GetV5QuotesDetailsWithHttpInfoAsync(string quoteNumber, string customerNumber, string isoCountryCode, string? thirdPartySource = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Search Quotes
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<QuoteListResponse> PostV5QuotesSearchAsync(QuoteListRequest? quoteListRequest = default(QuoteListRequest?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<QuoteListResponse>> PostV5QuotesSearchWithHttpInfoAsync(QuoteListRequest? quoteListRequest = default(QuoteListRequest?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class QuotesV5Api : IQuotesV5Api
    {
        ...
        /// <returns></returns>
        public QuotesV5Api(xi-sdk-csharp.Client.Configuration configuration)
        {
        ...
        public QuotesV5Api(xi-sdk-csharp.Client.ISynchronousClient client, xi-sdk-csharp.Client.IAsynchronousClient asyncClient, xi-sdk-csharp.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>QuoteDetails</returns>
        public QuoteDetails GetV5QuotesDetails(string quoteNumber, string customerNumber, string isoCountryCode, string? thirdPartySource = default(string?), int operationIndex = 0)
        {
            xi-sdk-csharp.Client.ApiResponse<QuoteDetails> localVarResponse = GetV5QuotesDetailsWithHttpInfo(quoteNumber, customerNumber, isoCountryCode, thirdPartySource);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of QuoteDetails</returns>
        public xi-sdk-csharp.Client.ApiResponse<QuoteDetails> GetV5QuotesDetailsWithHttpInfo(string quoteNumber, string customerNumber, string isoCountryCode, string? thirdPartySource = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'quoteNumber' is set
            if (quoteNumber == null)
            {
                throw new xi-sdk-csharp.Client.ApiException(400, "Missing required parameter 'quoteNumber' when calling QuotesV5Api->GetV5QuotesDetails");
            }

            // verify the required parameter 'customerNumber' is set
            if (customerNumber == null)
            {
                throw new xi-sdk-csharp.Client.ApiException(400, "Missing required parameter 'customerNumber' when calling QuotesV5Api->GetV5QuotesDetails");
            }

            // verify the required parameter 'isoCountryCode' is set
            if (isoCountryCode == null)
            {
                throw new xi-sdk-csharp.Client.ApiException(400, "Missing required parameter 'isoCountryCode' when calling QuotesV5Api->GetV5QuotesDetails");
            }
            ...
            {
                localVarRequestOptions.QueryParameters.Add(xi-sdk-csharp.Client.ClientUtils.ParameterToMultiMap("", "thirdPartySource", thirdPartySource));
            }

            localVarRequestOptions.Operation = "QuotesV5Api.GetV5QuotesDetails";
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of QuoteDetails</returns>
        public async System.Threading.Tasks.Task<QuoteDetails> GetV5QuotesDetailsAsync(string quoteNumber, string customerNumber, string isoCountryCode, string? thirdPartySource = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            xi-sdk-csharp.Client.ApiResponse<QuoteDetails> localVarResponse = await GetV5QuotesDetailsWithHttpInfoAsync(quoteNumber, customerNumber, isoCountryCode, thirdPartySource, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (QuoteDetails)</returns>
        public async System.Threading.Tasks.Task<xi-sdk-csharp.Client.ApiResponse<QuoteDetails>> GetV5QuotesDetailsWithHttpInfoAsync(string quoteNumber, string customerNumber, string isoCountryCode, string? thirdPartySource = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'quoteNumber' is set
            if (quoteNumber == null)
            {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>QuoteListResponse</returns>
        public QuoteListResponse PostV5QuotesSearch(QuoteListRequest? quoteListRequest = default(QuoteListRequest?), int operationIndex = 0)
        {
            xi-sdk-csharp.Client.ApiResponse<QuoteListResponse> localVarResponse = PostV5QuotesSearchWithHttpInfo(quoteListRequest);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of QuoteListResponse</returns>
        public xi-sdk-csharp.Client.ApiResponse<QuoteListResponse> PostV5QuotesSearchWithHttpInfo(QuoteListRequest? quoteListRequest = default(QuoteListRequest?), int operationIndex = 0)
        {
            xi-sdk-csharp.Client.RequestOptions localVarRequestOptions = new xi-sdk-csharp.Client.RequestOptions();
            ...
            localVarRequestOptions.Operation = "QuotesV5Api.PostV5QuotesSearch";
            localVarRequestOptions.OperationIndex = operationIndex;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of QuoteListResponse</returns>
        public async System.Threading.Tasks.Task<QuoteListResponse> PostV5QuotesSearchAsync(QuoteListRequest? quoteListRequest = default(QuoteListRequest?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            xi-sdk-csharp.Client.ApiResponse<QuoteListResponse> localVarResponse = await PostV5QuotesSearchWithHttpInfoAsync(quoteListRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (QuoteListResponse)</returns>
        public async System.Threading.Tasks.Task<xi-sdk-csharp.Client.ApiResponse<QuoteListResponse>> PostV5QuotesSearchWithHttpInfoAsync(QuoteListRequest? quoteListRequest = default(QuoteListRequest?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
