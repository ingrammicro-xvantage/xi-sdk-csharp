...
namespace xi-sdk-csharp.Api
{
    ...
    public partial class StockUpdateApi : IStockUpdateApi
    {
        ...
        /// <returns></returns>
        public StockUpdateApi(xi-sdk-csharp.Client.Configuration configuration)
        {
        ...
        public StockUpdateApi(xi-sdk-csharp.Client.ISynchronousClient client, xi-sdk-csharp.Client.IAsynchronousClient asyncClient, xi-sdk-csharp.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public xi-sdk-csharp.Client.ApiResponse<Object> ResellersV1WebhooksAvailabilityupdatePostWithHttpInfo(string targeturl, string xHubSignature, AvailabilityAsyncNotificationRequest availabilityAsyncNotificationRequest, int operationIndex = 0)
        {
            // verify the required parameter 'targeturl' is set
            if (targeturl == null)
            {
                throw new xi-sdk-csharp.Client.ApiException(400, "Missing required parameter 'targeturl' when calling StockUpdateApi->ResellersV1WebhooksAvailabilityupdatePost");
            }

            // verify the required parameter 'xHubSignature' is set
            if (xHubSignature == null)
            {
                throw new xi-sdk-csharp.Client.ApiException(400, "Missing required parameter 'xHubSignature' when calling StockUpdateApi->ResellersV1WebhooksAvailabilityupdatePost");
            }

            // verify the required parameter 'availabilityAsyncNotificationRequest' is set
            if (availabilityAsyncNotificationRequest == null)
            {
                throw new xi-sdk-csharp.Client.ApiException(400, "Missing required parameter 'availabilityAsyncNotificationRequest' when calling StockUpdateApi->ResellersV1WebhooksAvailabilityupdatePost");
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<xi-sdk-csharp.Client.ApiResponse<Object>> ResellersV1WebhooksAvailabilityupdatePostWithHttpInfoAsync(string targeturl, string xHubSignature, AvailabilityAsyncNotificationRequest availabilityAsyncNotificationRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'targeturl' is set
            if (targeturl == null)
            {
