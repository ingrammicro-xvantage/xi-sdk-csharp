...
namespace xi-sdk-csharp.Api
{
    ...
    public partial class QuoteToOrderApi : IQuoteToOrderApi
    {
        ...
        /// <returns></returns>
        public QuoteToOrderApi(xi-sdk-csharp.Client.Configuration configuration)
        {
        ...
        public QuoteToOrderApi(xi-sdk-csharp.Client.ISynchronousClient client, xi-sdk-csharp.Client.IAsynchronousClient asyncClient, xi-sdk-csharp.Client.IReadableConfiguration configuration)
        {
        ...
        {
            xi-sdk-csharp.Client.ApiResponse<QuoteToOrderResponse> localVarResponse = PostQuoteToOrderV6WithHttpInfo(iMCustomerNumber, iMCountryCode, iMCorrelationID, quoteToOrderDetailsDTO, iMSenderID);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of QuoteToOrderResponse</returns>
        public xi-sdk-csharp.Client.ApiResponse<QuoteToOrderResponse> PostQuoteToOrderV6WithHttpInfo(string iMCustomerNumber, string iMCountryCode, string iMCorrelationID, QuoteToOrderDetailsDTO quoteToOrderDetailsDTO, string? iMSenderID = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'iMCustomerNumber' is set
            if (iMCustomerNumber == null)
            {
                throw new xi-sdk-csharp.Client.ApiException(400, "Missing required parameter 'iMCustomerNumber' when calling QuoteToOrderApi->PostQuoteToOrderV6");
            }

            // verify the required parameter 'iMCountryCode' is set
            if (iMCountryCode == null)
            {
                throw new xi-sdk-csharp.Client.ApiException(400, "Missing required parameter 'iMCountryCode' when calling QuoteToOrderApi->PostQuoteToOrderV6");
            }

            // verify the required parameter 'iMCorrelationID' is set
            if (iMCorrelationID == null)
            {
                throw new xi-sdk-csharp.Client.ApiException(400, "Missing required parameter 'iMCorrelationID' when calling QuoteToOrderApi->PostQuoteToOrderV6");
            }

            // verify the required parameter 'quoteToOrderDetailsDTO' is set
            if (quoteToOrderDetailsDTO == null)
            {
                throw new xi-sdk-csharp.Client.ApiException(400, "Missing required parameter 'quoteToOrderDetailsDTO' when calling QuoteToOrderApi->PostQuoteToOrderV6");
            }
        ...
        {
            xi-sdk-csharp.Client.ApiResponse<QuoteToOrderResponse> localVarResponse = await PostQuoteToOrderV6WithHttpInfoAsync(iMCustomerNumber, iMCountryCode, iMCorrelationID, quoteToOrderDetailsDTO, iMSenderID, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (QuoteToOrderResponse)</returns>
        public async System.Threading.Tasks.Task<xi-sdk-csharp.Client.ApiResponse<QuoteToOrderResponse>> PostQuoteToOrderV6WithHttpInfoAsync(string iMCustomerNumber, string iMCountryCode, string iMCorrelationID, QuoteToOrderDetailsDTO quoteToOrderDetailsDTO, string? iMSenderID = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'iMCustomerNumber' is set
            if (iMCustomerNumber == null)
            {
