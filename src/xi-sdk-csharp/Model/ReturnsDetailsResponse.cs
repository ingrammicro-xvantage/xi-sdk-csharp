...
namespace xi-sdk-csharp.Model
{
    ...
    public partial class ReturnsDetailsResponse : IValidatableObject
    {
        ...
        public ReturnsDetailsResponse(string typeOfDetails = default(string), string rmaClaimId = default(string), string caseRequestNumber = default(string), DateTime createdOn = default(DateTime), string returnReason = default(string), string referenceNumber = default(string), string status = default(string), string returnWarehouseAddress = default(string), List<ReturnsDetailsResponseProductsInner> products = default(List<ReturnsDetailsResponseProductsInner>), decimal subTotal = default(decimal), decimal tax = default(decimal), decimal additionalFees = default(decimal), decimal estimatedTotal = default(decimal))
        {
