...
namespace xi-sdk-csharp.Model
{
    ...
    public partial class DealsSearchResponseDealsInner : IValidatableObject
    {
        ...
        public DealsSearchResponseDealsInner(string dealId = default(string), string varVersion = default(string), string endUser = default(string), string vendor = default(string), DateTime dealExpiryDate = default(DateTime), List<RenewalsSearchResponseRenewalsInnerLinksInner> links = default(List<RenewalsSearchResponseRenewalsInnerLinksInner>))
        {
            this.DealId = dealId;
