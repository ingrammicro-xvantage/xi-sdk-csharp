...
namespace xi-sdk-csharp.Model
{
    ...
    public partial class PriceAndAvailabilityResponseInnerDiscountsInnerSpecialPricingInner : IValidatableObject
    {
        ...
        public DateTime SpecialPricingEffectiveDate { get; set; }
        ...
        [JsonConverter(typeof(OpenAPIDateConverter))]
        public DateTime SpecialPricingExpirationDate { get; set; }
