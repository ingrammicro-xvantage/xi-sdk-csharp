...
namespace xi-sdk-csharp.Model
{
    ...
    public partial class ReturnsDetailsResponseProductsInner : IValidatableObject
    {
        ...
        public ReturnsDetailsResponseProductsInner(string ingramLineNumber = default(string), string description = default(string), string ingramPartNumber = default(string), string vendorPartNumber = default(string), string upc = default(string), DateTime invoiceDate = default(DateTime), string invoiceNumber = default(string), int customerOrderNumber = default(int), int requestDetails = default(int), int quantity = default(int), decimal unitPrice = default(decimal), decimal extendedPrice = default(decimal), string status = default(string), int returnBranch = default(int), int shipFromBranch = default(int))
        {
