...
namespace Example
{
    public class PostAsyncOrderCreateV7Example
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling OrdersApi.PostAsyncOrderCreateV7: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling OrdersApi.PostAsyncOrderCreateV7WithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
